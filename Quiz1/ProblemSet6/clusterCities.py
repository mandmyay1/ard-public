...
class Cluster(object):
    ...
    def __str__(self):
        ...
        return result[:-2]
# listPoints1 = []
# listPoints1.append(Point("0", [0,1]))
# listPoints1.append(Point("1", [1,1]))
# listPoints1.append(Point("2", [2,1]))
# listPoints1.append(Point("3", [3,1]))
# listPoints1.append(Point("4", [4,1]))
# listPoints1.append(Point("5", [5,1]))
# listPoints1.append(Point("6", [6,1]))
# listPoints1.append(Point("7", [7,1]))
# listPoints1.append(Point("8", [8,1]))
# listPoints1.append(Point("9", [9,1]))
# cluster1 = Cluster(listPoints1, Point)
# 
# listPoints2 = []
# listPoints2.append(Point("10", [1,0]))
# listPoints2.append(Point("11", [1,1]))
# listPoints2.append(Point("12", [1,2]))
# listPoints2.append(Point("13", [1,3]))
# listPoints2.append(Point("14", [1,4]))
# listPoints2.append(Point("15", [1,5]))
# listPoints2.append(Point("16", [1,6]))
# listPoints2.append(Point("17", [1,7]))
# listPoints2.append(Point("18", [1,8]))
# listPoints2.append(Point("19", [1,9]))
# cluster2 = Cluster(listPoints2, Point)
# 
# print cluster1.averageLinkageDist(cluster2)
# print cluster1.maxLinkageDist(cluster2)
# print cluster1.singleLinkageDist(cluster2)
...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        # TO DO
        newList = list(c1.members()) + list(c2.members())
        newCluster = Cluster(newList, self.pointType)
    ...
    def findClosest(self, linkage):
        ...
        for c1 in self.members:
            for c2 in self.members:
                ...
                if minDistance is None or linkageDistance < minDistance:
                    minDistance = linkageDistance
                    minPair = (c1, c2)
        return minPair
    def mergeOne(self, linkage):
        ...
        # TO DO
        closestPair = self.findClosest(linkage)
        self.mergeClusters(closestPair[0], closestPair[1])
        return closestPair
...
def test():
    ...
    #points2 = buildCityPoints('cityTemps.txt', True)
